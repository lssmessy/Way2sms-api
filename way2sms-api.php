...
function sendWay2SMS($uid, $pwd, $phone, $msg)
{
  ...
  //curl_setopt($curl, CURLOPT_URL, "http://site24".$autobalancer.".way2sms.com/Login1.action");
  curl_setopt($curl, CURLOPT_URL, "http://site24.way2sms.com/content/index.html");
  ...
  //curl_setopt($curl, CURLOPT_REFERER, "http://site24".$autobalancer.".way2sms.com/");
  curl_setopt($curl, CURLOPT_REFERER, "http://site24.way2sms.com/");
  $text = curl_exec($curl);
  ...
  //curl_setopt($curl, CURLOPT_URL, "http://site24".$autobalancer.".way2sms.com/jsp/InstantSMS.jsp");
  curl_setopt($curl, CURLOPT_URL, "http://site24.way2sms.com/jsp/InstantSMS.jsp");
  $text = curl_exec($curl);
  ...
  foreach ($pharr as $p)
  {
	...
	curl_setopt($curl, CURLOPT_URL, 'http://site24.way2sms.com/quicksms.action');
  ...
  curl_setopt($curl, CURLOPT_URL, "http://site24.way2sms.com/LogOut");
  curl_setopt($curl, CURLOPT_REFERER, $refurl);
  $text = curl_exec($curl);
